...
def update_colors(event):
    color_left = (r1.get(), g1.get(), b1.get())
    canvas_left.config(bg='#%02X%02X%02X' % color_left)
    color_right = (r2.get(), g2.get(), b2.get())
    canvas_right.config(bg='#%02X%02X%02X' % color_right)
    color_bottom = Color(color_left) + Color(color_right)
    canvas_bottom.config(bg='#%02X%02X%02X' % (color_bottom.R, color_bottom.G, color_bottom.B))
...
canvas_left.config(width=180, height=180, bg=""'#%02X%02X%02X' % (r1.get(), g1.get(), b1.get()))
canvas_right.config(width=180, height=180, bg=""'#%02X%02X%02X' % (r2.get(), g2.get(), b2.get()))
